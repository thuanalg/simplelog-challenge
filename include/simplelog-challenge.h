...
#define SPC_ST_LOBUFTOPIC(__t__, __i__) (&(__t__->arr_topic[__i__]))->buf
#define SPC_ST_LOBUFTOPIC_RANGE(__t__, __i__, __r__)                                                                          \
	((spc_gen_data_st *)((char *)SPC_ST_LOBUFTOPIC(__t__, __i__) + __t__->buff_size * __r__))
	...
	{                                                                                                                   \
		...
		if (__t__->llevel <= (__lv__) && ___fmttt___[0] && __t__->arr_topic) {                                      \
			...
			do {                                                                                                \
				...
				;                                                                                           \
				;                                                                                           \
				if (__t__->range > SPC_ST_LOBUFTOPIC_RANGE(__t__, __tpp__, __r__)->pl) {                      \
					;                                                                                   \
					memcpy(SPC_ST_LOBUFTOPIC_RANGE(__t__, __tpp__, __r__)->data +                         \
						   SPC_ST_LOBUFTOPIC_RANGE(__t__, __tpp__, __r__)->pl,                        \
					    __pprefmt__, __outlen__);                                                       \
					;                                                                                   \
					SPC_ST_LOBUFTOPIC_RANGE(__t__, __tpp__, __r__)->pl += __outlen__;                     \
					;                                                                                   \
					;                                                                                   \
					__len__ = snprintf(SPC_ST_LOBUFTOPIC_RANGE(__t__, __tpp__, __r__)->data +             \
							       SPC_ST_LOBUFTOPIC_RANGE(__t__, __tpp__, __r__)->pl,            \
					    __t__->krange - SPC_ST_LOBUFTOPIC_RANGE(__t__, __tpp__, __r__)->pl, \
						___fmttt___,  								\
					    ##__VA_ARGS__);                                                                 \
					;                                                                                   \
					;                                                                                   \
